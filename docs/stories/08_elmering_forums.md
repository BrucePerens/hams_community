...
* **Story:** As a reader, I want to instantly know the credentials of the person answering my question, so I can gauge the authority of the advice.
    * **BDD Criteria:**
        ...
        * *Then* the UI MUST render a WCAG-compliant trusted badge pulling their license class directly from ham.callbook. *(Reference: [@ANCHOR: render_forum_trust_badge])*
