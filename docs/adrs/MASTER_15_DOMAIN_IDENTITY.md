...
* Daemons MUST query these shadow views. Standard internal ERP users who lack the specific Ham/SWL security groups are natively excluded from the SQL `JOIN`. [%ANCHOR: sync_ham_indices]
