...
### 1. API Idempotency & HMAC Security (0011, 0067)
...
* Raw API secrets MUST NEVER be transmitted over the network (ADR-0067). All payloads and connection requests must be signed using HMAC-SHA256 (Proof-of-Possession) to verify identity securely.
