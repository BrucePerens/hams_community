...
def post_init_hook(env):
    ...
    3. Triggers documentation installation.
    """
    ...
    for url in legal_urls:
        ...
        if custom_pages:
            ...
            if boilerplate_pages:
                # We unpublish all boilerplate pages for this URL across all websites if a custom one exists.
                # In standard Odoo, pages are often website-specific.
                boilerplate_pages.write({"is_published": False})

    # Trigger documentation installation
