...
class IrHttp(models.AbstractModel):
    ...
    def _post_dispatch(cls, response):
        ...
        if any(path.startswith(prefix) for prefix in ("/web/static", "/web/assets")): # burn-ignore-route  # fmt: skip
        ...
        if any(path.startswith(prefix) for prefix in ("/my/", "/web/", "/api/")): # burn-ignore-route  # fmt: skip
