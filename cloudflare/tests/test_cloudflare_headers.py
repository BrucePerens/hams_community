...
class TestCloudflareHeaders(HttpCase):
    ...
    def test_01_static_asset_caching(self):
        ...
        response_img = self.url_open(f"/web/image/res.company/{company_id}/logo") # burn-ignore-route  # fmt: skip
        ...
        mock_request.httprequest.path = "/web/assets/1/dummy.js" # burn-ignore-route  # fmt: skip
