...
class TestSubscriptionsAndDigest(HttpCase):
    ...
    def test_01_weekly_digest_and_unsubscribe_headers(self):
        ...
        self.assertTrue(
            "/website/unsubscribe/res.partner/" in unsub_url, # burn-ignore-route  # fmt: skip
    ...
    def test_02_invalid_unsubscribe_token(self):
        ...
        url = f"/website/unsubscribe/res.partner/{self.creator.partner_id.id}/{self.follower.partner_id.id}/{current_ts}/{fake_token}" # burn-ignore-route  # fmt: skip
