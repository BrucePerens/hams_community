...
- **Then** I can request a full export of my data ([@ANCHOR: UX_GDPR_EXPORT]).
- **And** the system generates a machine-readable JSON file containing all my pages, blog posts, and metadata ([@ANCHOR: res_users_gdpr_export]).
...
- **Then** the system schedules a background process to permanently delete all my hosted content ([@ANCHOR: gdpr_sudo_erasure]).
