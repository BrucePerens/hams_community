        ...
        def generate_pages():
            ...
            while True:
                ...
                if is_test:
                    ...
                    items = [
                        {"name": p.name, "url": p.url, "content": p.arch} for p in batch
                    ]
                else:
            ...
            while True:
                ...
                if is_test:
                    ...
                    batch = (
                        ...
                        .with_user(svc_uid)
                        .search([("user_id", "=", user_id)], limit=1000, offset=offset)
                    )
                    items = [
                        {
                            "reason": a.reason,
