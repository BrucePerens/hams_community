...
class TestScheduleEdgeCases(TransactionCase):
    def test_01_empty_schedule(self):
        ...
        self.assertFalse(admin, "MUST return False when the schedule is completely empty.")
    ...
    def test_02_overlapping_shifts(self):
        ...
        self.assertIn(admin.id, [user1.id, user2.id], "MUST safely return one of the overlapping users without crashing.")
