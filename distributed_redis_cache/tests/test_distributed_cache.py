...
class TestDistributedCacheStandard(HttpCase):
    def test_01_redis_cache_interceptor_standard(self):
        ...
        with patch(
            "odoo.addons.distributed_redis_cache.models.ir_http.redis_pool", MagicMock()
        ), patch(
            "odoo.addons.distributed_redis_cache.models.ir_http.redis"
        ) as mock_redis, patch(
            "odoo.addons.base.models.ir_http.IrHttp._authenticate", return_value=True
        ):
    ...
    def test_02_redis_interceptor_fails_open_standard(self):
        ...
        with patch(
            ...
            "odoo.addons.distributed_redis_cache.models.ir_http.request", MagicMock()
        ), patch(
            "odoo.addons.base.models.ir_http.IrHttp._authenticate", return_value=True
        ):
    ...
    def test_05_redis_scan_invalidation_standard(self):
        ...
        """
        with patch(
            "odoo.addons.distributed_redis_cache.redis_cache.redis_pool", MagicMock()
    ...
    def test_08_notify_model_invalidation_logic(self):
        ...
        ) as mock_invalidate, patch.object(self.env.cr, "execute") as mock_execute:
...
class TestDistributedCacheIntegration(HamsIntegrationCase):
    ...
    def setUpClass(cls):
        ...
        daemon_path = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "..", "daemons", "cache_manager.py")
        )
    ...
    def test_01_redis_cache_interceptor_integration(self):
        ...
        with patch("odoo.addons.base.models.ir_http.request", mock_req_inst), patch(
            "odoo.addons.distributed_redis_cache.models.ir_http.request", mock_req_inst
