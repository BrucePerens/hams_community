...
1. **Create Configuration**: The administrator navigates to **Ham Admin > Backups > Configurations** and creates a new record ([@ANCHOR: backup_dashboard_tour]).
...
5. **Execution**: Odoo executes the engine-specific list command `[@ANCHOR: backup_management:backup_sync_kopia]`.
