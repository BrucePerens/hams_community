...
* **Self-Writable Fields:** Appends `website_meta_title`, `website_meta_description`, `website_meta_keywords`, `website_meta_og_img`, and `seo_name` to the user's `_get_writeable_fields` whitelist (ADR-0015). This allows standard users to save SEO data without requiring backend Administrator rights.
