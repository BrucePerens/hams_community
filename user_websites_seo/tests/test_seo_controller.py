...
class TestSEOController(TransactionCase):
    ...
    @patch(
        "odoo.addons.user_websites_seo.controllers.main.UserWebsitesController.user_blog_index"
    )
    def test_controller_no_ssti_elevation(self, mock_super_index):
        ...
        self.assertEqual(
            ...
            "The main_object should not have elevated privileges (SSTI protection)",
        )
