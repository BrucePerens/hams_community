...
class TestRealTransactionFacility(RealTransactionCase):
    ...
    def test_02_leak_detector_catches_raw_sql(self):
        ...
        self.cr.execute("INSERT INTO ir_module_category (name) VALUES ('\"SQL Leak Test\"') RETURNING id")
        ...
        self.assertIn('ir_module_category', leaks, "The leak detector MUST catch raw SQL insertions.")
