...
inside 'core_base.group_user_manager_service'.
"""
    ...
    for root, dirs, files in os.walk("."):
        ...
        for file in files:
            if file.endswith((".xml", ".csv", ".py")):
                ...
                if "core_base.group_portal" in content:
                    new_content = content.replace("core_base.group_portal", "core_base.group_user")
